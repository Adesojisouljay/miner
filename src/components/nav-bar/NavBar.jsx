...
import { FaGreaterThan, FaHome, FaEnvelope, FaTachometerAlt, FaSpinner, FaUsers, FaUser, FaCogs, FaWallet, FaIdCard  } from "react-icons/fa";
                ...
                <div className='dropdown-menu' style={{ height: '100vh' }}>
                  ...
                  <div className='menu-cont'>
                    ...
                    <ul>
                      ...
                      {user?.role === "admin" && <>
                      <li><Link to="/controller">Controllers</Link></li>
                      ...
                      <li onClick={(e) => { handleLogout(e); closeDropdown(); }}>
                        <Link to="/">
                          <FaUsers className="menu-icon" /> Logout
                        </Link>
                      </li>
                    </ul>
                  </div>
