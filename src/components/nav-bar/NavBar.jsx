  ...
  return (
    ...
    <nav className="navbar">
      <div className="nav-content">
        <div className="logo">
          <img src={logo} alt="" />
          <div className="project-name" onClick={handleRightNav}>
            <p>Ekza</p>
            <p>Trade</p>
          </div>
        </div>
          ...
          {isAuthenticated ? (
            <div className='avatar-container'>
              <div className="user-top-info" >
                ...
                <PiGreaterThanBold className='left-arrow-icon' />
              </div>
              {dropdownOpen && (
                  ...
                  <div className='menu-cont'>
                    <div className="user-section">
                        ...
                        <div className="user-info-section">
                          ...
                          <h4> Kyc Status: <span style={{color: "green"}}>Verified✅</span></h4>
                        </div>
                        <div>
        ...
        {/* <RightNav isOpen={rightNav } closePage={handleRightNav} /> */}
